...
df_filtrado <- QPC_11_ %>%
  filter(
    ...
    grepl("NM|M|W|WA|WM", Status, ignore.case = TRUE)  # "|" means OR in regex
  )
...
#tabla6$`QPC_Original_Amount_NGSG_1` <- tabla6$`QPC_Original_Amount` / tabla6$`T-1_NGSG`
#mediana_valor <- median(tabla6$`QPC_Original_Amount_NGSG_1`[is.finite(tabla6$`QPC_Original_Amount_NGSG_1`)], na.rm = TRUE)
#tabla6$`QPC_Original_Amount_NGSG_1`[is.infinite(tabla6$`QPC_Original_Amount_NGSG_1`)] <- mediana_valor

#tabla6$`QPC_Original_Amount_NGSG_2` <- tabla6$`QPC_Original_Amount` / tabla6$`T-2_NGSG`
#mediana_valor <- median(tabla6$`QPC_Original_Amount_NGSG_2`[is.finite(tabla6$`QPC_Original_Amount_NGSG_2`)], na.rm = TRUE)
#tabla6$`QPC_Original_Amount_NGSG_2`[is.infinite(tabla6$`QPC_Original_Amount_NGSG_2`)] <- mediana_valor

# tabla6$`QPC_Original_Amount_NGSG_3` <- tabla6$`QPC_Original_Amount` / tabla6$`T-3_NGSG`
# mediana_valor <- median(tabla6$`QPC_Original_Amount_NGSG_3`[is.finite(tabla6$`QPC_Original_Amount_NGSG_3`)], na.rm = TRUE)
# tabla6$`QPC_Original_Amount_NGSG_3`[is.infinite(tabla6$`QPC_Original_Amount_NGSG_3`)] <- mediana_valor

#tabla6$`QPC_Original_Amount_NGSG_t` <- tabla6$`QPC_Original_Amount` / tabla6$`T_NGSG`
#mediana_valor <- median(tabla6$`QPC_Original_Amount_NGSG_t`[is.finite(tabla6$`QPC_Original_Amount_NGSG_t`)], na.rm = TRUE)
#tabla6$`QPC_Original_Amount_NGSG_t`[is.infinite(tabla6$`QPC_Original_Amount_NGSG_t`)] <- mediana_valor

#tabla6$`QPC_Original_Amount_NGSG+1` <- tabla6$`QPC_Original_Amount` / tabla6$`T+1_NGSG`
#mediana_valor <- median(tabla6$`QPC_Original_Amount_NGSG+1`[is.finite(tabla6$`QPC_Original_Amount_NGSG+1`)], na.rm = TRUE)
#tabla6$`QPC_Original_Amount_NGSG+1`[is.infinite(tabla6$`QPC_Original_Amount_NGSG+1`)] <- mediana_valor

##tabla6$`QPC_Original_Amount_NGSG+2` <- tabla6$`QPC_Original_Amount` / tabla6$`T+2_NGSG`
#mediana_valor <- median(tabla6$`QPC_Original_Amount_NGSG+2`[is.finite(tabla6$`QPC_Original_Amount_NGSG+2`)], na.rm = TRUE)
#tabla6$`QPC_Original_Amount_NGSG+2`[is.infinite(tabla6$`QPC_Original_Amount_NGSG+2`)] <- mediana_valor

#tabla6$`QPC_Original_Amount_NGSG+3` <- tabla6$`QPC_Original_Amount` / tabla6$`T+3_NGSG`
#mediana_valor <- median(tabla6$`QPC_Original_Amount_NGSG+3`[is.finite(tabla6$`QPC_Original_Amount_NGSG+3`)], na.rm = TRUE)
#tabla6$`QPC_Original_Amount_NGSG+3`[is.infinite(tabla6$`QPC_Original_Amount_NGSG+3`)] <- mediana_valor
...
# tabla6$`QPC_Original_Amount_NCG_3` <- tabla6$`QPC_Original_Amount` / tabla6$`T-3_NCG`
# mediana_valor <- median(tabla6$`QPC_Original_Amount_NCG_3`[is.finite(tabla6$`QPC_Original_Amount_NCG_3`)], na.rm = TRUE)
# tabla6$`QPC_Original_Amount_NCG_3`[is.infinite(tabla6$`QPC_Original_Amount_NCG_3`)] <- mediana_valor
...
#tabla6 <- tabla6 %>% mutate(Sub.Option_NIR_floor_QPC_Original_Amount_ENDA_1_exp_BXG = Sub.Option_NIR_floor * QPC_Original_Amount_ENDA_1 ^ correccion_T1_BXG)
#tabla6 <- tabla6 %>% mutate(Sub.Option_NIR_floor_QPC_Original_Amount_ENDA_1_exp_BCA = Sub.Option_NIR_floor * QPC_Original_Amount_ENDA_1 ^ var_t1_t_BCA)
#tabla6 <- tabla6 %>% mutate(Sub.Option_NIR_floor_QPC_Original_Amount_ENDA_2 = Sub.Option_NIR_floor * QPC_Original_Amount_ENDA_2)
#tabla6 <- tabla6 %>% mutate(Sub.Option_NIR_floor_QPC_Original_Amount_ENDA_2_exp_BXG = Sub.Option_NIR_floor * QPC_Original_Amount_ENDA_2 ^ correccion_T2_BXG)
#tabla6 <- tabla6 %>% mutate(Sub.Option_NIR_floor_QPC_Original_Amount_ENDA_2_exp_BCA = Sub.Option_NIR_floor * QPC_Original_Amount_ENDA_2 ^ var_t2_t1_BCA)
#tabla6 <- tabla6 %>% mutate(Sub.Option_NIR_floor_QPC_Original_Amount_ENDA_3 = Sub.Option_NIR_floor * QPC_Original_Amount_ENDA_3)
#tabla6 <- tabla6 %>% mutate(Sub.Option_NIR_floor_QPC_Original_Amount_ENDA_3_exp_BXG = Sub.Option_NIR_floor * QPC_Original_Amount_ENDA_3 ^ correccion_T3_BXG)
#tabla6 <- tabla6 %>% mutate(Sub.Option_NIR_floor_QPC_Original_Amount_ENDA_3_exp_BCA = Sub.Option_NIR_floor * QPC_Original_Amount_ENDA_3 ^ var_t3_t2_BCA)
#tabla6 <- tabla6 %>% mutate(Sub.Option_NIR_floor_QPC_Original_Amount_ENDA_4 = Sub.Option_NIR_floor * QPC_Original_Amount_ENDA_4)
#tabla6 <- tabla6 %>% mutate(Sub.Option_NIR_floor_QPC_Original_Amount_ENDA_4_exp = Sub.Option_NIR_floor * QPC_Original_Amount_ENDA_4 ^ correccion_T4_BXG)
...
write_xlsx(tabla6, "C:/Users/HP/Desktop/Tesis UDESA/tabla_para_modelos19.xlsx")
